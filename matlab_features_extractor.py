# -*- coding: utf-8 -*-
"""
Created on Fri Sep 30 02:50:16 2016
...
# Adding void preprocessing stage ( for each epoch, with channels ) :    
...
def calculate_features(file_name):
    ...
    for i in range(1, numSamps+1):
        ...
        # Mobility
        mobility = np.sqrt(np.divide(np.std(np.diff(epoch)), np.std(epoch)))
        # Complexity
...
feat = calculate_features('./Data/train_1/1_101_1.mat')
print(feat)
print(feat.shape[0])
